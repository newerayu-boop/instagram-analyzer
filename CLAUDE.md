...
Спецэффекты: встреча при входе — глянцевый робот (robot2-cut.webp) выглядывает
справа, говорит «Assalomu alaykum!» и утягивает фиолетовую обложку вправо,
открывая сайт; все 20 слайдов каруселей — бегущей 3D-волной (референс: пин
TIDY, ru.pinterest.com/pin/606086062398825953); сайт мастер-класса — отдельная
секция «KATTA LOYIHA» с автопрокруткой в рамке браузера (26s, пауза по ховеру). Секций «Обо мне»
