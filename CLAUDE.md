...
Спецэффекты: встреча при входе — **нарисованный SVG-робот в худи** (референс
стиля — ai-sovga.vercel.app, но свой): стоит в полный рост, при открытии ссылки
**загораются розовые глаза** (вспышка с дрожью → ровное свечение), машет
поднятой рукой и говорит «Assalomu alaykum!»; через 3s уходит, клик пропускает.
Рамок-уголков нет — убраны по просьбе. Заставка видна из CSS сразу, а её скрипт
стоит прямо за разметкой: если ждать конца парсинга, на миг видно сам сайт.
