...
Спецэффекты: встреча при входе — робот **собирается из нейронов** на canvas
(силуэт задан точками в коде, слетаются за 1.15s), машет и говорит
«Assalomu alaykum!»; все 20 слайдов каруселей — бегущей 3D-волной (референс:
