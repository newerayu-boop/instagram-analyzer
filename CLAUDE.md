...
## Материалы к урокам курса (2026-08-07)

Курс = **15 живых офлайн-уроков** («AI-интегратор», UZ). План пост-урочных пакетов —
[`docs/course-lesson-materials.md`](docs/course-lesson-materials.md): по каждому уроку
5 блоков (конспект · шаблоны · инструменты · видео · домашка с критерием), стартовый
пакет до урока 1, сводная таблица производства по приоритетам. Ключевые точки риска:
установка стека перед уроком 6 и **отсутствующая 1-я часть урока 12** (нужно
видео-восполнение). Тексты для студентов переводим скиллом `uzbek-expert-voice`.
